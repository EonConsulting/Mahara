...
$cfg->log_backtrace_levels = LOG_LEVEL_ENVIRON | LOG_LEVEL_WARN;

//8 bit indicator <256
$cfg->error_reporting = E_ALL & ~E_STRICT; // | E_USER_ERROR | E_WARNING | E_STRICT | E_RECOVERABLE_ERROR;
...
$cfg->emaillog = $cfg->dataroot . '/email.log';
