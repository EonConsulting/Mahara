<?php
/*
 * Landing page for loging in Mahara through Basic LTI. 
 * 
 ...
 * The BLTI security module is responsible to redirect the user to a single sign on page.
...
$manager = new login_manager_blti();
$manager->process();
